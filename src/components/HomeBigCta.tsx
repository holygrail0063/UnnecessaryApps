...
export function HomeBigCta() {
  return (
    <section className="relative overflow-hidden border-y-[3px] border-ink bg-pink-main px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      <span
        className="pointer-events-none absolute left-[6%] top-[18%] font-display text-4xl font-black text-text-main/25 motion-safe-wiggle"
        aria-hidden
      >
        →
      </span>
      <span
        className="pointer-events-none absolute bottom-[12%] right-[10%] text-5xl motion-safe-float"
        aria-hidden
      >
        ✎
      </span>
